    ...
    <section class="bg-white">
        <div class="mx-auto max-w-5xl px-5 py-16 lg:py-20">
            <div class="text-center">
                ...
                <h1 class="mt-2 text-4xl font-semibold tracking-tight text-[#1d1d1f] sm:text-5xl">Tentang koperasi kami.</h1>
            </div>
            ...
            <div class="mx-auto mt-14 grid max-w-4xl gap-5 md:grid-cols-2">
                <div class="rounded-3xl bg-[#f5f5f7] p-8">
                    <h2 class="text-2xl font-semibold tracking-tight text-[#1d1d1f]">Visi.</h2>
                ...
                <div class="rounded-3xl bg-[#f5f5f7] p-8">
                    <h2 class="text-2xl font-semibold tracking-tight text-[#1d1d1f]">Misi.</h2>
            ...
            {{-- Pengurus --}}
            <div class="mt-16">
                <h2 class="text-center text-3xl font-semibold tracking-tight text-[#1d1d1f]">Struktur pengurus.</h2>
                <div class="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-3">
                    <div class="rounded-3xl bg-[#f5f5f7] p-8 text-center">
                        ...
                        <h3 class="mt-4 text-base font-semibold text-[#1d1d1f]">Ketua Koperasi</h3>
                    ...
                    <div class="rounded-3xl bg-[#f5f5f7] p-8 text-center">
                        ...
                        <h3 class="mt-4 text-base font-semibold text-[#1d1d1f]">Bendahara</h3>
                    ...
                    <div class="rounded-3xl bg-[#f5f5f7] p-8 text-center">
                        ...
                        <h3 class="mt-4 text-base font-semibold text-[#1d1d1f]">Sekretaris</h3>
