...
<body class="bg-canvas font-sans text-stone-900 antialiased">
    ...
    <header class="sticky top-0 z-40 border-b border-stone-200/60 bg-white/85 backdrop-blur-xl">
        <div class="mx-auto flex h-16 max-w-5xl items-center justify-between gap-4 px-5">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-3 shrink-0">
                <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-teal-600 to-emerald-700 shadow-md shadow-teal-700/30">
    ...
    {{-- ═══ Footer (Dark) ═══ --}}
    <footer class="mt-24 bg-stone-950 text-stone-400">
        <div class="mx-auto max-w-5xl px-5 pt-16 pb-8">
            ...
            <div class="flex flex-col gap-12 md:flex-row md:justify-between">
                ...
                <div class="max-w-xs">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-teal-500 to-emerald-600 shadow-lg shadow-teal-900/50">
                            <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 3c2.755 0 5.455.232 8.083.678.533.09.917.556.917 1.096v1.044a2.25 2.25 0 01-.659 1.591l-5.432 5.432a2.25 2.25 0 00-.659 1.591v2.927a2.25 2.25 0 01-1.244 2.013L9.75 21v-6.568a2.25 2.25 0 00-.659-1.591L3.659 7.409A2.25 2.25 0 013 5.818V4.774c0-.54.384-1.006.917-1.096A48.32 48.32 0 0112 3z" />
                            </svg>
                        </div>
                        <div class="leading-none">
                            <div class="font-bold text-white">Koperasi Desa Kradenan</div>
                            <div class="text-xs text-stone-500 mt-0.5">SIMPERDES</div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-10 sm:grid-cols-3">
                    <div>
                        <div class="text-xs font-bold uppercase tracking-wider text-stone-300">Menu</div>
                        <ul class="mt-4 space-y-2.5 text-sm">
                            <li><a href="{{ route('home') }}" class="transition hover:text-teal-400">Beranda</a></li>
                            <li><a href="{{ route('produk') }}" class="transition hover:text-teal-400">Katalog Produk</a></li>
                            <li><a href="{{ route('tentang') }}" class="transition hover:text-teal-400">Tentang Kami</a></li>
                            <li><a href="{{ route('kontak') }}" class="transition hover:text-teal-400">Kontak</a></li>
                        </ul>
                    </div>
                    <div>
                        <div class="text-xs font-bold uppercase tracking-wider text-stone-300">Kontak</div>
                        <ul class="mt-4 space-y-2.5 text-sm">
                            <li>
                                <a href="https://wa.me/6281234567890" target="_blank" rel="noopener"
                                   class="flex items-center gap-1.5 transition hover:text-green-400">
                            ...
                            <li><a href="mailto:halo@koperasidesa.id" class="transition hover:text-teal-400">halo@koperasidesa.id</a></li>
                            <li class="text-stone-500 text-xs leading-relaxed">Jl. Raya Sumpiuh, Kradenan, Kec. Sumpiuh, Banyumas 53196</li>
                        </ul>
                    </div>
                    <div>
                        <div class="text-xs font-bold uppercase tracking-wider text-stone-300">Jam Layanan</div>
                        <div class="mt-4 space-y-3">
                            <div class="flex items-center gap-2 text-sm">
                                <span class="h-2 w-2 rounded-full bg-green-400 shrink-0 animate-pulse" aria-hidden="true"></span>
                                <span class="font-semibold text-white">Senin – Jumat</span>
                            </div>
                            <div class="text-sm">07.15 – 15.30 WIB</div>
                            <div class="text-xs text-stone-600">Sabtu & Minggu: Tutup</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- Copyright --}}
            <div class="mt-12 flex flex-wrap items-center justify-between gap-3 border-t border-stone-800 pt-6 text-xs text-stone-600">
                <span>&copy; {{ date('Y') }} Koperasi Desa Kradenan. Hak cipta dilindungi.</span>
                <a href="{{ route('login') }}" class="transition hover:text-stone-400">Login Staff &middot; Ditenagai SIMPERDES</a>
            </div>
        </div>
    </footer>
