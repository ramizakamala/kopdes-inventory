...
@section('content')
    <section class="mx-auto max-w-7xl px-5 py-14 lg:px-8">
        <div class="max-w-2xl">
            <span class="text-sm font-bold uppercase tracking-wider text-teal-700">Tentang</span>
            <h1 class="mt-2 text-4xl font-extrabold tracking-tight text-stone-900">Tentang Koperasi Kami</h1>
        </div>

        <div class="mt-10 grid gap-10 lg:grid-cols-2">
            <div class="space-y-5 text-[15px] leading-relaxed text-stone-600">
                <p>
            ...
            <div class="card p-6">
                <h2 class="text-lg font-bold text-stone-900">Visi</h2>
                ...
                <h2 class="mt-6 text-lg font-bold text-stone-900">Misi</h2>
                <ul class="mt-2 space-y-2.5 text-[15px] leading-relaxed text-stone-600">
        ...
        {{-- Pengurus --}}
        <div class="mt-16">
            <h2 class="text-2xl font-extrabold tracking-tight text-stone-900">Struktur Pengurus</h2>
            <div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-3">
                <div class="card p-6 text-center">
                    <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-teal-700 text-white shadow-sm">
                        <svg class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                        </svg>
                    </div>
                    <h3 class="mt-4 text-base font-bold text-stone-900">Ketua Koperasi</h3>
                ...
                <div class="card p-6 text-center">
                    ...
                    <h3 class="mt-4 text-base font-bold text-stone-900">Bendahara</h3>
                ...
                <div class="card p-6 text-center">
                    ...
                    <h3 class="mt-4 text-base font-bold text-stone-900">Sekretaris</h3>
