...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $beras = Barang::create(['kode_barang' => 'BRG-001', 'nama_barang' => 'Beras Premium 5kg', 'kategori_id' => $sembako->id, 'satuan' => 'karung', 'harga_beli' => 62000, 'harga_jual' => 68000, 'stok_minimum' => 10, 'lead_time_hari' => 5, 'safety_stock' => 15, 'stok_saat_ini' => 25, 'is_batch_tracked' => false, 'deskripsi' => 'Beras premium hasil panen petani lokal, dipoles bersih dan dikemas 5 kg. Cocok untuk konsumsi harian keluarga.']);
        $minyak = Barang::create(['kode_barang' => 'BRG-002', 'nama_barang' => 'Minyak Goreng 1L', 'kategori_id' => $sembako->id, 'satuan' => 'pcs', 'harga_beli' => 15000, 'harga_jual' => 17000, 'stok_minimum' => 20, 'lead_time_hari' => 3, 'safety_stock' => 2, 'stok_saat_ini' => 8, 'is_batch_tracked' => false, 'deskripsi' => 'Minyak goreng sawit kemasan botol 1 liter, bening dan tidak mudah berbau.']);
        $pupuk = Barang::create(['kode_barang' => 'BRG-003', 'nama_barang' => 'Pupuk Urea 50kg', 'kategori_id' => $pertanian->id, 'satuan' => 'sak', 'harga_beli' => 110000, 'harga_jual' => 120000, 'stok_minimum' => 5, 'lead_time_hari' => 7, 'safety_stock' => 2, 'stok_saat_ini' => 0, 'is_batch_tracked' => false, 'deskripsi' => 'Pupuk urea bersubsidi kemasan 50 kg untuk padi, jagung, dan palawija.']);
        $obat = Barang::create(['kode_barang' => 'BRG-004', 'nama_barang' => 'Vitamin C 100mg', 'kategori_id' => $kesehatan->id, 'satuan' => 'strip', 'harga_beli' => 8000, 'harga_jual' => 10000, 'stok_minimum' => 15, 'lead_time_hari' => 4, 'safety_stock' => 3, 'stok_saat_ini' => 12, 'is_batch_tracked' => true, 'deskripsi' => 'Suplemen vitamin C 100 mg per tablet, isi 10 tablet per strip.']);
        $gula = Barang::create(['kode_barang' => 'BRG-005', 'nama_barang' => 'Gula Pasir 1kg', 'kategori_id' => $sembako->id, 'satuan' => 'pcs', 'harga_beli' => 16500, 'harga_jual' => 18000, 'stok_minimum' => 10, 'lead_time_hari' => 3, 'safety_stock' => 3, 'stok_saat_ini' => 30, 'is_batch_tracked' => false, 'deskripsi' => 'Gula pasir putih kemasan 1 kg, manis dan bersih.']);
        $susu = Barang::create(['kode_barang' => 'BRG-006', 'nama_barang' => 'Susu Kental Manis', 'kategori_id' => $sembako->id, 'satuan' => 'kaleng', 'harga_beli' => 9000, 'harga_jual' => 11000, 'stok_minimum' => 25, 'lead_time_hari' => 3, 'safety_stock' => 2, 'stok_saat_ini' => 5, 'is_batch_tracked' => true, 'deskripsi' => 'Susu kental manis kaleng 370 ml, cocok untuk minuman dan campuran masakan.']);
